...
const CreateEvent = () => {
  ...
  // Ensure VITE_CLOUDINARY_LINK is set in your .env file
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FIX: Type narrowing instead of 'any'
        ...
        <GeneralLayout>
             ...
             <div className="min-h-screen flex items-center justify-center p-4">
                <div className="bg-white/5 border border-white/10 p-10 rounded-2xl text-center backdrop-blur-lg max-w-md w-full animate-in fade-in zoom-in duration-300">
                    ...
                    <p className="text-gray-400 mb-6">You must be an organizer to create events. Please sign in to continue.</p>
  ...
  return (
    <GeneralLayout>
        ...
        <div className="min-h-screen py-20 px-4 flex justify-center items-start pt-32">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-2xl h-fit border border-purple-500/30 bg-black/40 backdrop-blur-md rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="flex flex-col items-center pt-8 pb-4 bg-white/5 border-b border-white/10">
              ...
              <div className="mt-6 flex gap-3 items-center">
                <div className={`h-2.5 w-12 rounded-full transition-colors duration-300 ${step >= 1 ? 'bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]' : 'bg-gray-700'}`}></div>
                <div className={`h-2.5 w-12 rounded-full transition-colors duration-300 ${step >= 2 ? 'bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]' : 'bg-gray-700'}`}></div>
              </div>
              <p className="text-gray-400 mt-2 text-xs uppercase tracking-widest">Step {step} of 2</p>
            </div>
            ...
            <div className="px-8 py-8 flex flex-col gap-6">
                ...
                <div className='flex flex-col gap-6 animate-in fade-in slide-in-from-right-8 duration-300'>
                   ...
                   <div className="group">
                    <label
                        ...
                        ${imageFile ? 'border-purple-500 bg-purple-500/10 text-purple-200' : 'border-gray-600 text-gray-500 hover:border-purple-400 hover:text-purple-400 hover:bg-white/5'}`}
                    >
                        <div className="text-3xl mb-2">{imageFile ? '🖼️' : '☁️'}</div>
                        {fileLabel}
                    </label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Event Title</label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Short Tagline / Slug</label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Location</label>
                  ...
                  <div className="flex md:flex-row flex-col gap-6">
                    <div className="flex flex-col gap-1 w-full">
                      <label className='text-gray-300 text-sm font-medium ml-1'>Date</label>
                    ...
                    <div className="flex flex-col gap-1 w-full">
                      <label className='text-gray-300 text-sm font-medium ml-1'>Time</label>
                  ...
                  <div className='flex justify-end mt-4'>
                    <button onClick={handleNext} className="bg-purple-600 hover:bg-purple-500 text-white font-bold py-3 px-8 rounded-full shadow-[0_0_20px_rgba(147,51,234,0.3)] hover:shadow-[0_0_30px_rgba(147,51,234,0.5)] transition-all duration-300 w-full md:w-auto flex items-center justify-center gap-2">
              ...
              {step === 2 && (
                <div className='flex flex-col gap-6 animate-in fade-in slide-in-from-right-8 duration-300'>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Full Address</label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Organizer Name</label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Detailed Overview</label>
                  ...
                  <div>
                    <label className='text-gray-300 text-sm font-medium ml-1'>Agenda / Schedule</label>
                    <textarea name="agenda" value={formData.agenda} onChange={handleChange} rows={4}
                      className="mt-1 border border-gray-600 bg-white/5 w-full p-3 rounded-lg focus:outline-none focus:border-purple-500 focus:bg-white/10 transition-all placeholder-gray-500" 
                      placeholder="e.g. 9:00 AM - Registration..." />
                  </div>

                  <div className='flex justify-between items-center mt-8 gap-4'>
                    <button onClick={handleBack} className="px-6 py-2 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition-all flex items-center gap-2">
                      <span>←</span> Back
                    </button>
