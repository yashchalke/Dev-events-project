...
const EventDetails = () => {
  ...
  const isOrganizer =
    isUserLoaded && user && event && user.id === event.createdBy;
      ...
      <GeneralLayout>
        ...
        <div className="mt-20 p-6 md:p-10 min-h-screen">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 mb-8">
            <h1 className="heading text-4xl md:text-6xl font-bold text-white mb-2 tracking-tight">
              {event.title}
            </h1>
          ...
          <div className="flex md:flex-row flex-col gap-10">
            <div className="w-full md:w-[65%] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                ...
                {isOrganizer ? (
                  <div className="bg-white/10 border border-white/20 p-6 rounded-xl text-center shadow-xl backdrop-blur-md">
                    ...
                    <p className="text-gray-300 text-sm mb-4">
                      Scan attendee tickets for entry.
                    </p>
                    <Link to="/scan-ticket">
              ...
              <div className="mb-10">
                <h3 className="font-special-gothic text-3xl text-white mb-4 border-b border-white/10 pb-2">
                  Overview
                </h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 mb-10 shadow-xl">
                <h3 className="font-special-gothic text-2xl text-bg-main mb-6 uppercase tracking-wider text-sm">
                  Event Information
                </h3>
              ...
              <div className="mb-20">
                <h3 className="font-special-gothic text-3xl text-white mb-6 border-b border-white/10 pb-2">
                  Organizer
                </h3>
                <div className="flex items-center gap-6 bg-white/5 p-6 rounded-xl border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-bg-main uppercase tracking-wider mt-1">
                      Official Event Host
                    </p>
                  </div>
                </div>
                ...
                {isOrganizer ? (
                  <div className="bg-white/10 border border-white/20 p-8 rounded-xl text-center shadow-2xl backdrop-blur-xl">
                    ...
                    <p className="text-xs text-gray-500 mt-4">
                      Use this tool to validate attendee entry.
                    </p>
                  </div>
                ) : (
                  <MiniForm eventId={event._id} />
